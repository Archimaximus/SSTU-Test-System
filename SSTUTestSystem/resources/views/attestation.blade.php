        ...
        <div class="content-block">
            <fieldset>
                ...
                <div class="question">
                    <form>
                        <div>
                            <input id="var_1" type="radio" name="var" value="1"> <!-- type: checkbox, text, number -->
                        ...
                        <div>
                            <label for="var_4">Факт 4<img src="" alt="" style="max-height: 300px"></label>
                            <div class="dropdown">
                                <input  type="text" />
            ...
            тут вообще инпут, который принимает в себя значение выпадающего списка, который скрыт за инпутом
            <div class="dropdown">
              <input type="text" />
              <select  onchange="this.previousElementSibling.value=this.value; this.previousElementSibling.focus()">
            ...
            фин вариант:
            <div>
                <label for="var_4">Вариант 4<img src="" alt="" style="max-height: 300px"></label>
                <div class="dropdown">
                    <input type="text" />
                    <select  onchange="this.previousElementSibling.value=this.value; this.previousElementSibling.focus()">
                    <option>This is option 1</option>
